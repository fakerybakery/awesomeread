...
window.onload = function() {
    ...
    if (document.querySelector('form[action="search.php"] input[name=query]')) {
        document.querySelector('form[action="search.php"] input[name=query]').setAttribute('placeholder', 'Search Forums...');
    }
